...
import com.kll.collect.android.tasks.AttachmentUploaderTask;
...
/**
 * Created by pujan on 11/27/15.
 */
public class AttachmentUploaderActivity extends Activity implements InstanceUploaderListener {
    private final static String t = "AttachmentUploaderActivity";
    ...
    private AttachmentUploaderTask mAttachmentUploaderTask;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(getString(R.string.app_name) + " > " + getString(R.string.send_attachment));
        ...
        mAttachmentUploaderTask = (AttachmentUploaderTask) getLastNonConfigurationInstance();
        if (mAttachmentUploaderTask == null) {
            // setup dialog and upload task
            showDialog(PROGRESS_DIALOG);
            mAttachmentUploaderTask = new AttachmentUploaderTask();

            // register this activity with the new uploader task
            mAttachmentUploaderTask.setUploaderListener(AttachmentUploaderActivity.this);

            mAttachmentUploaderTask.execute(mInstancesToSend);
        }
    }
    ...
    protected void onResume() {
        ...
        if (mAttachmentUploaderTask != null) {
            mAttachmentUploaderTask.setUploaderListener(this);
        }
        if (mAlertShowing) {
    ...
    public Object onRetainNonConfigurationInstance() {
        return mAttachmentUploaderTask;
    }
    ...
    protected void onDestroy() {
        if (mAttachmentUploaderTask != null) {
            mAttachmentUploaderTask.setUploaderListener(null);
        }
        super.onDestroy();
    }
                ...
                DialogInterface.OnClickListener loadingButtonListener =
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                dialog.dismiss();
                                mAttachmentUploaderTask.cancel(true);
                                mAttachmentUploaderTask.setUploaderListener(null);
                                finish();
                            }
                        };
