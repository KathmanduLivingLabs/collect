...
import com.kll.collect.android.tasks.InstanceUploaderNoAttachmentTask;
import com.kll.collect.android.tasks.InstanceUploaderTask;
 ...
 */
public class InstanceUploaderNoAttachmentActivity extends Activity implements InstanceUploaderListener {
    ...
    private InstanceUploaderNoAttachmentTask mInstanceUploaderTask;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mInstanceUploaderTask = (InstanceUploaderNoAttachmentTask) getLastNonConfigurationInstance();
        if (mInstanceUploaderTask == null) {
            // setup dialog and upload task
            showDialog(PROGRESS_DIALOG);
            mInstanceUploaderTask = new InstanceUploaderNoAttachmentTask();

            // register this activity with the new uploader task
            mInstanceUploaderTask.setUploaderListener(InstanceUploaderNoAttachmentActivity.this);
